...
module.exports = (sequelize, DataTypes) => {
    ...
    User.associate = function(model) {
        User.belongsToMany(User, {as: 'Creator', through: 'Subscribe', foreignKey: 'UserId', otherKey: 'CreatorId'});
        User.belongsToMany(User, {as: 'Subscriber', through: 'Subscribe', foreignKey: 'CreatorId', otherKey: 'UserId'});
